...
// if (!$isPublished) {
    Route::group(['prefix' => 'payment'], function () {
        ...
        Route::group(['prefix' => 'fawry', 'as' => 'fawry.'], function () {
            Route::get('pay', [FawryController::class, 'payment']);
            Route::any('response', [FawryController::class, 'response'])->name('responseee');
            Route::post('/webhook', [FawryController::class, 'fawryWebhook'])->name('webhook');
        });
