        ...
        <div class="container-fluid">
            @if(access_checker('dashboard'))
                <div class="row mb-4 g-4">
                    <div class="col-lg-3 col-sm-6">
                        <a href="{{ route('admin.report.transaction') }}">
                            <div class="business-summary business-summary-customers">
                                ...
                                <img src="{{asset('public/assets/admin-module')}}/img/icons/customers.png" class="absolute-img" alt="">
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <a href="{{ route('admin.report.provider') }}">
                            <div class="business-summary business-summary-earning">
                                ...
                                <img src="{{asset('public/assets/admin-module')}}/img/icons/total-earning.png" class="absolute-img" alt="">
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <a href="{{ route('admin.customer.index') }}" class="business-summary-link">
                            <div class="business-summary business-summary-providers">
