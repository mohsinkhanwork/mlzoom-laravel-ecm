                ...
                <div class="col-12 pb-4">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        {{-- <button type="button" class="btn btn--success" data-bs-toggle="modal"
                                ...
                                <form action="{{route('admin.provider.import')}}" id="uploadProgressForm" method="post"
...
@push('script')
    ...
    <script
     src="https://maps.googleapis.com/maps/api/js?key={{ env('GOOGLE_MAPS_API_KEY') }}&libraries=places&v=3.45.8"></script>
