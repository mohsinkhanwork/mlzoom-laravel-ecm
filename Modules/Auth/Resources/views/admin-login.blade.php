<!DOCTYPE html>
<html lang="{{session()->get('landing_local') ?? 'ar'}}" dir="{{session()->get('landing_local')  == 'ar' ? 'rtl' : 'ltr'}}">
    <style>.larger-section {
        font-size: 16px; /* Adjust the font size as needed */
        padding: 20px; /* Adjust the padding as needed */
        /* Add any other styling you want to adjust */
    }</style>
<head>
...
<div class="login-form dark-support" data-bg-img="{{asset('public/assets/admin-module')}}/img/media/login-bg.png">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-xl-7" style="
    margin-left: auto;
">
                        ...
                        <div class="login-wrap">
                            ...
                            <div class="login-right-wrap">
                                ...
                                <div class="login-right">
                                        ...
                                        <div class="mb-30">
                                            <div class="form-floating">
                                                <input type="text" name="email_or_phone" class="form-control"
                                                       placeholder="{{translate('email_or_phone')}}" required="" id="email_or_phone">
                                    ...
                                    <div class="mt-3 d-flex flex-wrap gap-1 justify-content-center larger-section" style="color:#000000 !important;font-weight: 800;">
                                        {{translate('want_to_sign_in_to_your_provider_account')}} ?
                                        <a href="{{route('provider.auth.login')}}" class="c2 text-capitalize" style="border-bottom: outset;color:#d30d0d !important;">{{translate('sign_in_here')}}</a>
                                    </div>
