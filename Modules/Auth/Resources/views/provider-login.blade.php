                        ...
                        <div class="login-wrap">
                            ...
                            <div class="login-right-wrap">
                                        ...
                                        <div class="mb-30">
                                            <div class="form-floating">
                                                <input type="text" name="email_or_phone" class="form-control"
                                                       placeholder="{{translate('email_or_phone')}}" required="" id="email">
                                ...
                                @if(business_config('provider_self_registration','provider_config')->live_values??0)
                                    <div class="text-center fz-12 pb-4" style="c;font: message-box;color:#000000 !important;font-weight: 900;">
                                        {{translate('Want to Register as Provider')}} <a
                                            href="{{route('provider.auth.sign-up')}}"
                                            class="c2" style="border-bottom: outset;color:#d30d0d !important;">{{translate('Register Here')}}</a>
                                    </div>
                                @endif
